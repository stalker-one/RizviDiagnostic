...
// Font size is intentionally NOT here: Practice Settings already has the
// single authoritative Thermal Font Size field.
const FIELDS = [
...
export default function ThermalSettingsEnhancer(){
 ...
 return createPortal(<div className="border-t border-slate-100 pt-4 mt-4 space-y-5">
  <div><h4 className="font-semibold text-slate-700">Thermal Layout</h4><p className="text-xs text-slate-500 mt-1">The main thermal font size remains in Practice Settings above. These controls adjust the remaining receipt layout.</p></div>
