...
const POSITIONS=[['top-left','Top left'],['top-center','Top center'],['top-right','Top right'],['center-left','Center left'],['center','Center'],['center-right','Center right'],['bottom-left','Bottom left'],['bottom-center','Bottom center'],['bottom-right','Bottom right'],['after-booked-by','After Booked by'],['before-thank-you','Before Thank You']];
