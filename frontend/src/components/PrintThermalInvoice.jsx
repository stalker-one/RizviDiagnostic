...
export default function PrintThermalInvoice({invoice,settings}){
 ...
 // Fix stamp settings - ensure all stamp props are passed correctly
 const thermalStampSettings={
   ...settings,
   thermalStampFontSize: settings?.thermalStampFontSize || settings?.thermalStampFontSizePx || 12,
   thermalStampClinicNameFontSize: settings?.thermalStampClinicNameFontSize || settings?.thermalStampClinicNameFontSizePx || 14,
   thermalStampDateTimeFontSize: settings?.thermalStampDateTimeFontSize || settings?.thermalStampDateTimeFontSizePx || 10,
   thermalStampWidth: settings?.thermalStampWidth || 120,
   thermalStampHeight: settings?.thermalStampHeight || 120
 };
